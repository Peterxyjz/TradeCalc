    ...
    <div className="min-h-screen pb-8 pt-10">
      <div className="container">
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-primary pl-4">
                ...
                <ul className="text-sm space-y-1 ml-4">
                  ...
                  <li>• Nhấn <strong>&ldquo;Tiếp tục&rdquo;</strong></li>
                </ul>
              </div>
              ...
              <div className="border-l-4 border-primary pl-4">
                ...
                <ul className="text-sm space-y-1 ml-4">
                  ...
                  <li>• Nhấn <strong>&ldquo;Tính giá vào lệnh&rdquo;</strong></li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <div className="card bg-blue-50 border-blue-200 p-4">
                ...
                <div className="text-sm space-y-1">
                  ...
                  <div className="mt-3 p-2 bg-white rounded border">
                    <p className="font-medium">→ Kết quả: <span className="text-accent">Giá vào lệnh 100 USDT</span></p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Advanced Features */}
          <div className="card">
            <h2 className="text-lg font-semibold mb-4">⚡ Tính năng nâng cao</h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="space-y-2 ml-4">
                  <p className="text-sm">• Nhấn <strong>&ldquo;Nâng cao&rdquo;</strong> bên cạnh ô SL</p>
                  <p className="text-sm">• Nhập <strong>giá Entry</strong> (ví dụ: 100.5)</p>
                  <p className="text-sm">• Nhập <strong>giá SL</strong> (ví dụ: 98.5)</p>
                  <p className="text-sm">• Nhấn <strong>&ldquo;Tính SL%&rdquo;</strong></p>
                  <p className="text-sm">• SL% sẽ được tự động tính và điền vào</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2 ml-4">
                  <p className="text-sm">• Nhấn <strong>&ldquo;0.5R&rdquo;</strong> để giảm 50% ngay lập tức</p>
                  <p className="text-sm">• Hoặc nhấn <strong>&ldquo;Tùy chỉnh&rdquo;</strong> và nhập % muốn giảm</p>
          ...
          {/* Tips */}
          <div className="card">
            <h2 className="text-lg font-semibold mb-4">💡 Mẹo sử dụng hiệu quả</h2>
            ...
            <div className="space-y-3">
              ...
              <div className="card bg-blue-50 border-blue-200 p-3">
                <h4 className="font-medium text-blue-800 mb-1">🎯 Khuyến nghị cho người mới</h4>
